...
public class DataCheck {
    ...
    static {
        String line = "";
        try(BufferedReader bufferedReader = Files.newBufferedReader(Paths.get("F:\\data\\AQX\\product.txt"), Charset.forName("UTF-8"))) {
    ...
    public static void main(String[] args) {
        ...
        String line = "";
        String fileLoc = "F:\\data\\AQX\\20151231.txt";
        System.out.println(LocalDateTime.now()+"开始生成list");
        try(BufferedReader bufferedReader = Files.newBufferedReader(Paths.get(fileLoc), Charset.forName("UTF-16"))) {
//        try(BufferedReader bufferedReader = Files.newBufferedReader(Paths.get(fileLoc), Charset.forName("GBK"))) {
            while ((line=bufferedReader.readLine())!=null){
                ...
                Long cost = Long.valueOf(split[12]);*/
                /*平面
